...
@router.get("/test_question_route", summary="Test Question Route")
async def test_question_route():
    return {"message": "Question router test successful"}
...
# 
# 
# @router.get("/generate_followup_questions", response_model=TextResponse, summary="生成后续问题")
...
#         fields_to_delete = ["question", "sql", "df", "fig_json", "followup_questions", "summary"]
